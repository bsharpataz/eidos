...
object EidosSystem {
  ...
  // CAG filtering
  val PROTEST_DEMAND = Set(PROTEST_LABEL, DEMAND_LABEL)
  val EXPANDABLE: Set[String] = Set(CAUSAL_LABEL, CORR_LABEL, COREF_LABEL, DEMAND_LABEL, PROTEST_LABEL, RESPONSE_LABEL)
  val CAG_EDGES: Set[String] = Set(CAUSAL_LABEL, CORR_LABEL, COREF_LABEL, DEMAND_LABEL, PROTEST_LABEL, VIOLENCE1_LABEL, VIOLENCE2_LABEL, VIOLENCE3_LABEL, RESPONSE_LABEL)
}
